...
// Editor de código TSX con preview en vivo; lo usan el widget custom y los
// editores de header/mensajes del chat
export function CustomWidgetEditorModal({
  ...
  // El preview recompila con cada cambio de código o props
